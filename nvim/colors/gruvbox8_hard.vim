...
" Last Updated: Mon May  3 01:46:25 2021
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    let g:terminal_ansi_colors = ['#1D2324', '#cc241d', '#98971a', '#d79921', '#458588', '#b16286', '#689d6a', '#a89984', '#928374', '#fb4934', '#b8bb26', '#fabd2f', '#83a598', '#d3869b', '#8ec07c', '#ebdbb2']
    if has('nvim')
      let g:terminal_color_0 = '#1D2324'
      let g:terminal_color_1 = '#ff531b'
      let g:terminal_color_2 = '#98971a'
      let g:terminal_color_3 = '#d79921'
      let g:terminal_color_4 = '#458588'
      let g:terminal_color_5 = '#ff531b'
    ...
    hi Conditional guifg=#9C717D guibg=NONE gui=NONE cterm=NONE
    hi Constant guifg=#9C717D guibg=NONE gui=NONE cterm=NONE
    ...
    hi Function guifg=#7c8584 guibg=NONE gui=bold cterm=bold
    ...
    hi Keyword guifg=#9C717D guibg=NONE gui=NONE cterm=NONE
    ...
    if get(g:, "gruvbox_plugin_hi_groups", 0)
      ...
      hi LspDiagnosticsSignError guifg=#fb4934 guibg=#1d2021 gui=NONE cterm=NONE
  ...
  " Light background
  let g:terminal_ansi_colors = ['#3c3836', '#cc241d', '#98971a', '#d79921', '#458588', '#b16286', '#689d6a', '#7c6f64', '#928374', '#9d0006', '#79740e', '#b57614', '#076678', '#ff002e', '#427b58', '#f9f5d7']
  if has('nvim')
    let g:terminal_color_0 = '#3c3836'
    let g:terminal_color_1 = '#427b58'
    let g:terminal_color_2 = '#98971a'
    let g:terminal_color_3 = '#d79921'
    let g:terminal_color_4 = '#458588'
    ...
    let g:terminal_color_13 = '#9b7a86'
  ...
  hi Define guifg=#3a85fe427b58 guibg=NONE gui=NONE cterm=NONE
  ...
  hi Macro guifg=#9d0006 guibg=NONE gui=NONE cterm=#9d0006
  ...
  hi SpecialComment guifg=#427b58 guibg=#427b58 gui=#427b58 cterm=NONE
  ...
  if get(g:, "gruvbox_plugin_hi_groups", 0)
    ...
    hi LspDiagnosticsSignError guifg=#9d0006 guibg=#f9f5d7 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi SpecialComment ctermfg=35 ctermbg=NONE cterm=NONE
    ...
    if get(g:, "gruvbox_plugin_hi_groups", 0)
      ...
      hi CocErrorSign ctermfg=203 ctermbg=234 cterm=NONE
      hi CocWarningSign ctermfg=214 ctermbg=234 cterm=NONE
      ...
      hi CocSelectedText ctermfg=237 ctermbg=234 cterm=NONE
      ...
      hi LspDiagnosticsSignError ctermfg=203 ctermbg=234 cterm=NONE
    ...
    if get(g:, "gruvbox_filetype_hi_groups", 0)
      ...
      hi haskellStatement ctermfg=Red ctermbg=NONE cterm=NONE
  ...
  "This is for multi /* style comments"
  hi SpecialComment ctermfg=35 ctermbg=NONE cterm=NONE
  hi Statement ctermfg=Red ctermbg=NONE cterm=NONE
  ...
  if get(g:, "gruvbox_plugin_hi_groups", 0)
    ...
    hi CocErrorSign ctermfg=124 ctermbg=229 cterm=NONE
    hi CocWarningSign ctermfg=172 ctermbg=229 cterm=NONE
    ...
    hi CocSelectedText ctermfg=187 ctermbg=229 cterm=NONE
    ...
    hi LspDiagnosticsSignError ctermfg=124 ctermbg=229 cterm=NONE
